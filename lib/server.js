...
Server.prototype.start = function() {
  ...
  this.app.post('/fp-setup', this._onPostFpSetup.bind(this));
  this.app.get('/server-info', this._onServerInfo.bind(this));
  this.app.get('/playback-info', this._onGetPlaybackInfo.bind(this));
  this.app.get('/scrub', this._onGetScrub.bind(this));
  this.app.post('/scrub', this._onPostScrub.bind(this));
  ...
  this.app.put('/setProperty', this._onSetProperty.bind(this));
